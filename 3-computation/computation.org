...
- [[#الvectors][الvectors]]
  ...
  - [[#التعامل-مع-الbad-input][التعامل مع الbad input]]
...
كل اللي هو بيعمله انه بيستني منك input، وهو سنك وبعدها اسمك، وبيقولك رساله فيها اسمك وسنك وهكذا لحد لما توقفه بEOF ب C-d

مشكله البرنامج دا انه فيه كذا خطأ، تعالي نحاول نصلحهم واحد واحد بدايه بأول وأوضح خطأ وهو ان مفيش prompt! لو بعت البرنامج دا لصاحبك يجربه لازم تقوله انه المفروض انه يدخل سنه وبعدها اسمه، لأن غير كدا هو مش هيفهم البرنامج دا بيعمل ايه ولا عايز ايه.

خلينا نصلح المشكله دي ونحط prompt، بس هنحطها فين؟ ممكن مثلا نحطها قبل الloop؟

#+begin_src C++
int main() {
    std::string name;
    int age;
    std::cout << "Enter you age followed by your name:\n> ";
    while (std::cin >> age >> name)
        std::cout << "Hello, " << name << " (age " << age << ")\n";
}
#+end_src>
