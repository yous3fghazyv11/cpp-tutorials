...
int main() {
    ...
    int age;
    while (std::cout << "Enter you age followed by your name:\n> ") {
        std::cin >> name >> age && std::cout << "input statement executed\n";
        std::cout << "Hello, " << name << " (age " << age << ")\n";
        print_cin_state();
...
واللي هيحصل هنا ان الstring بتاعنا yousef هيتخزن في حاجه اسمها input buffer علشان يمكن نستخدمه بعد كدا. علشان نوضح الموضوع دا بشكل احسن، بص مثلا المثال دا:
