...
اللي السطر دا بيعمله باختصار انه بيطبع "!Hello, World" لل standard output واللي هو ال terminal وبعد كدا بينزل سطر،

بمعني انه بعد لما هيخلص طباعه الحروف: ='!' ,'H', 'e', 'l', 'l', 'o', ',', ' ', 'W', 'o', 'r', 'l', 'd'= هيقوم طابع الحرف =n\= وده هيخليه ينزل سطر

منغير ال =n\= البرنامج هيعمل كدا: [[../images/hello_world_no_newline.png]]
